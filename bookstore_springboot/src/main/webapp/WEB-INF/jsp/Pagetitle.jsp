                        ...
                        <td>
                            ...
                            <div class="pagination">
                                <ul>
                                    ...
                                    <li class="disablepage"><a href="${pageContext.request.contextPath  }/pagetitlelist.do?currentPage=${currentPage==1?1:currentPage-1}">&lt;&lt;上一页</a></li>


                                    <li>this is ${currentPage }page/total${totalPage==0?1:totalPage}pages</li>

                                    <li class="nextPage"><a href="${pageContext.request.contextPath  }/pagetitlelist.do?currentPage=${currentPage==totalPage?totalPage:currentPage+1}">&lt;&lt;下一页</a></li>
