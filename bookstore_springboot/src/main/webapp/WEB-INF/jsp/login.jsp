							...
							<div>
								<table width="85%" border="0" cellspacing="0">
									<tr>
													...
													<tr>
														<td style="text-align:center">
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	<td
																		style="text-align:right; padding-top:5px; width:25%">Username：${requestScope["usr_msg"]}</td>
																...
																<tr>
																	<td colspan="2" style="text-align:center"><input
																		...
																		name="checkbox" value="checkbox" /> Automatic Login</td>
																</tr>
																<tr>
																	<td colspan="2"
										...
										<td style="text-align:left; padding-top:30px; width:60%"><h1>You have not registered yet?</h1>
											<p>Register new members to enjoy more preferential prices!</p>
											<p>Thousands of books for your selection! Register to enjoy rich discounts and benefits, cheap and good goods! Choose more than ten thousand books。</p>
											<p>Super-popular community! Wonderful activities every day. Trading more peace of mind! Alipay deal ultra-secure.</p>
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath}/register.do"><img
