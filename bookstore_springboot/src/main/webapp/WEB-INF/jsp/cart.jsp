...
<head>
	...
	<script type="text/javascript">
        function changeNum(id,num,totalCount){
            ...
            if(num>totalCount){
                alert("The number of purchases can not be greater than the number of stocks!");
                num=totalCount;
            }
								...
								<tr>
									<td>
										...
										<table cellspacing="1" class="carttable">
											<tr>
												<td style="text-align:right; padding-right:40px;"><font
														style="color:#FF6600; font-weight:bold">合计：&nbsp;&nbsp;${sum}dollars</font>
												</td>
											</tr>
										</table>
										<div style="text-align:right; margin-top:10px">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;<a
												href="${pageContext.request.contextPath}/order"><img
