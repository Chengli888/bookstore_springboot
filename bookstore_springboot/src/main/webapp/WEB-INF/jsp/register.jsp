...
<body class="main">
	...
	<div id="divcontent">
		<form action="${pageContext.request.contextPath}/User_Register.do"
			method="post">
			<table width="850px" border="0" cellspacing="0">
				<tr>
					<td style="padding:30px">
						<h1>New member registration ${user_msg}</h1>
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								<td style="text-align:right; width:20%">Enter the check code：</td>
