				...
				<td style="padding:30px; text-align:center"><table width="60%"
						...
						<tr>
							...
							<td style="padding-top:30px"><font
								style="font-weight:bold; color:#FF0000">User information is modified successfully, please login again</font><br /> <br />
								<a href="index.html">Click here jump to home page contuine shopping</a></td>
						</tr>
					</table>
					<h1>&nbsp;</h1></td>
			</tr>
