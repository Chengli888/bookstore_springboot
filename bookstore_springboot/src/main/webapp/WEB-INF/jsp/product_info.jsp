									...
									<tr>
										<td width="30%">
											...
											<div style="text-align:center; margin-top:25px">
												<a href="${pageContext.request.contextPath }/addCart.do?id=${productinfo.id}">
										...
										<td style="padding:20px 5px 5px 5px"><img
											...
											class="bookname">&nbsp;&nbsp;${productinfo.name}</font>

											<hr />售价：<font color="#FF0000">${productinfo.price}</font>
											<hr /> 类别：${productinfo.category}

											<hr />
											<p>
												<b>内容简介：</b>
											</p> ${productinfo.description}</td>
									</tr>
								</table></td>
						</tr>
					</table>
